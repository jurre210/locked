...
export const CHARACTERS = [
  {
    id:'wren', build:'normal', name:'Wren', blurb:'Nothing special. That is the point.',
  ...
  {
    id:'mabel', build:'normal', name:'Mabel', blurb:'Carries a card and a lot of hope.',
  ...
  {
    id:'ash', build:'normal', name:'Ash', blurb:'Everything he touches keeps burning.',
  ...
  {
    id:'pip', build:'small', name:'Pip', blurb:'Small, quick, and made of paper.',
  ...
  {
    id:'sable', build:'normal', name:'Sable', blurb:'Runs on borrowed hearts only.',
  ...
  {
    id:'husk', build:'broad', name:'Husk', blurb:'What is left after the rest gave up.',
  ...
  {
    id:'tallow', build:'small', name:'Tallow', blurb:'Hold it in until it means something.',
  ...
  {
    id:'crick', build:'small', name:'Crick', blurb:'Something got in and stayed.',
  ...
  {
    id:'nought', build:'normal', name:'Nought', blurb:'Walks through what stops everyone else.',
  ...
  {
    id:'veil', build:'small', name:'Veil', blurb:'Feet have not touched the floor in years.',
  ...
  {
    id:'bramble', build:'broad', name:'Bramble', blurb:'Better up close than she should be.',
  ...
  {
    id:'runt', build:'small', name:'Runt', blurb:'Found something on the way in.',
  ...
  {
    id:'dregs', build:'small', name:'Dregs', blurb:'Starts with nothing. Ends with everything.',
  ...
  {
    id:'cinder', build:'broad', name:'Cinder', blurb:'Always has one more use left.',
